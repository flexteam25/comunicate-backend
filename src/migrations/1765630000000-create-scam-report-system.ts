...
export class CreateScamReportSystem1765630000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop indexes
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_scam_report_site_unique"',
    );
    await queryRunner.dropIndex(
      "scam_report_site",
      "IDX_scam_report_site_scam_report_id",
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "IDX_scam_report_reactions_unique"',
    );
    await queryRunner.dropIndex(
      "scam_report_reactions",
    ...
    const scamReportReactionsTable = await queryRunner.getTable(
      "scam_report_reactions",
    );
    ...
    const scamReportCommentImagesTable = await queryRunner.getTable(
      "scam_report_comment_images",
    );
    ...
    const scamReportCommentsTable = await queryRunner.getTable(
      "scam_report_comments",
    );
